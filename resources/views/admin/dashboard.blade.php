                    ...
                    <div class="card mb-4">
                        <div class="card-body d-flex flex-column py-0">
                            ...
                            <div class="card-spacer bg-white card-rounded flex-grow-1">
                                ...
                                <div class="row m-0">
                                    <div class="col py-6">
                                        <div class="font-size-h5-xl text-primary font-weight-bold">Average Sale</div>
                                        <div class="font-size-h4 font-weight-bolder">&#2547;650</div>
                                    </div>

                                    <div class="col py-6">
                                        <div class="font-size-h5-xl text-warning font-weight-bold">Commission</div>
                                        <div class="font-size-h4 font-weight-bolder">&#2547;233,600</div>
                                    </div>
                                    <div class="col py-6">
                                        <div class="font-size-h5-xl text-success font-weight-bold">Annual Taxes</div>
