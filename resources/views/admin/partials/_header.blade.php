<div class="container d-flex align-items-stretch justify-content-between">
    ...
    <div class="d-flex align-items-stretch mr-3">
        ...
        <div class="header-logo">
            <a href="index.html">
                <img alt="Logo" src="{{asset('admin')}}/assets/media/logos/logo-letter-9.png" class="logo-default max-h-40px" />
                <img alt="Logo" src="{{asset('admin')}}/assets/media/logos/logo-letter-1.png" class="logo-sticky max-h-40px" />
            </a>
        </div>
        <!--end::Header Logo-->
