                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input type="text" v-on:keyup="search_keyword" v-model="searchKeyword"
                                                    name="searchKeyword" id="searchKeyword"
                                                    class="form-control form-control-solid" placeholder="Search Keyword">
                                            </div>
                                            <ul class="list-group"
                                                ...
                                                <li style="cursor: pointer;" class="list-group-item list-hover"
                                                    ...
                                                    <a
                                                        v-bind:href="'member/'+ result.id">@{{ result . name }}-@{{ result . mobile }}</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
